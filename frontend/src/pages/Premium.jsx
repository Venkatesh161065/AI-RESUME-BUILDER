...
const Premium = () => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const orderResponse = await axios.post('https://backend-pi-six-94.vercel.app/api/payment/create-order', {}, {
            ...
            const options = {
                ...
                handler: async function (response) {
                    try {
                        // 3. Verify on backend
                        const verifyRes = await axios.post('https://backend-pi-six-94.vercel.app/api/payment/verify', {
